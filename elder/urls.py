...
urlpatterns = [
    ...
    path('graph-dashboard/<str:pk>',views.VitalGraphDataView.as_view(), name='vital_graph'),
    path('report-data/',views.ReportDataView.as_view(), name='report_data_post'),
    path('report-data/<str:pk>',views.ReportDataView.as_view(), name='report_data_get'),
    path('chart-data/<str:pk>',views.ChartDataView.as_view(), name='chart_data'),
    path('relative-list/<str:pk>', views.PatientListViewRelative.as_view(), name='relative_list'),
    path('relpat_data/', views.RelativePatientDataView.as_view(), name='relpat_view'),
    path('auth/token/', TokenObtainPairView.as_view(), name='token_obtain_pair'),
    path('auth/token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    path('auth/logout/blacklist/', views.BlacklistTokenUpdateView.as_view(),name='blacklist'),
